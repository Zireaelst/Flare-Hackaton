// Vendored from flare-foundation/flare-viem-starter (MIT).
// IMemoInstructionsFacet is not exported by the periphery package, but Tempo
// needs it for getNonce and the UserOperationExecuted event.
export const abi = [
  {
    type: "function",
    name: "getExecutor",
